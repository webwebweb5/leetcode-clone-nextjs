  ...
  return (
    <div className="h-screen relative">
      <div className="max-w-7xl mx-auto">
        <Navbar />
        <div className="flex flex-col items-center justify-center gap-10 h-[calc(100vh-5rem)]">
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center lg:items-start">
            <span className="relative">Level up your coding skills</span>
          ...
          <div className="flex justify-center align-center gap-3">
            <div className="-space-x-5 flex overflow-hidden">
              <div className="rounded-full border-smooth-dark border-4 w-fit h-fit">
